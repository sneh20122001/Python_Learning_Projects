...
lab_hr = Label(clock,text="00",font=("Times New Roman",50,"bold"))
...
lab_min = Label(clock,text="00",font=("Times New Roman",50,"bold"))
...
lab_sec = Label(clock,text="00",font=("Times New Roman",50,"bold"))
...
lab_date = Label(clock,text="00",font=("Times New Roman",50,"bold"))
...
lab_mo = Label(clock,text="00",font=("Times New Roman",50,"bold"))
...
lab_year = Label(clock,text="00",font=("Times New Roman",50,"bold"))
